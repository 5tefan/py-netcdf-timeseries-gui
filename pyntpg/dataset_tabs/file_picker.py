...
class FilePicker(QtGui.QWidget):
    ...
    def __init__(self):
        ...
        file_icon = QtGui.QLabel()
        file_icon.setPixmap(self.style().standardIcon(QtGui.QStyle.SP_DialogOpenButton).pixmap(10))
        ...
        self.filelist.setVerticalScrollMode(QtGui.QAbstractItemView.ScrollPerPixel)
